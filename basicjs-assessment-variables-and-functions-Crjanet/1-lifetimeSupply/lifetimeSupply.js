...
let favoriteSnack = prompt("What's your favorite snack?")
let quantityADay= prompt("How many of your favorite snack can you eat in a day?")
let age = prompt("How old ae you?")

    let ageDifference = 100 - age
    let years = 365
    let totalOfDays = years * ageDifference
    let totalEat = totalOfDays * quantityADay
